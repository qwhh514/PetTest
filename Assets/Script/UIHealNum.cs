...
public class UIHealNum : MonoBehaviour {
	...
	void Start () {
		...
		this.m_damagePrefab = AssetManager.Singleton.LoadAsset<GameObject>(FilePath.FONT_PATH + "green.prefab");
	...
	public void AddHealNum(int nDamage)
	{
